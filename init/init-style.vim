...
" Last Modified: 2020/12/17 17:10:32
"
"======================================================================
...
set signcolumn=yes
autocmd Filetype man set signcolumn=no
...
"hi! SpellCap gui=underline guifg=magenta
"hi! SpellRare gui=undercurl guifg=cyan
"
""syn match matchURL '/http[s]\?:\/\/[[:alnum:]%\/_#.-]*/'
"hi! clear mkdInlineURL
"hi mkdInlineURL gui=underline
"
""if has('gui_running')
